...
public class Tarefa02 extends javax.swing.JFrame {
    public Tarefa02() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Tarefa02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
