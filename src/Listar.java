...
public class Listar extends javax.swing.JFrame {
    ...
    private void btn_ConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ConsultarActionPerformed
        ...
        String rf[]           = new String[linha.length];
        String nome[]         = new String[linha.length];
        String nomePai[]      = new String[linha.length];
        String nomeMae[]      = new String[linha.length];
        String endereco[]     = new String[linha.length];
        String rg[]           = new String[linha.length];
        String telefone[]     = new String[linha.length];
        String email[]        = new String[linha.length];
        String salario[]      = new String[linha.length];
        String departamento[] = new String[linha.length];
        
        //Guardando os dados nos seus respectivos arrays através do loop
        while(contDados < linha.length){
        ...
        while(contConsulta < linha.length){
